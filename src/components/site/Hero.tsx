...
import heroImg from "@/assets/greensouk/lifestyle-1.jpg";
...
export function Hero() {
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-7xl px-5 md:px-8 lg:px-10 grid lg:grid-cols-12 gap-10 md:gap-12 lg:gap-16 items-center">
        <motion.div
        ...
        >
          ...
          <h1 className="mt-6 font-display text-[2.4rem] sm:text-5xl md:text-6xl lg:text-[4.5rem] leading-[1.02] text-foreground">
            Mercado natural,{" "}
          ...
          <div className="mt-9 flex flex-col sm:flex-row sm:flex-wrap items-stretch sm:items-center gap-3">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group inline-flex items-center justify-center gap-2 rounded-full bg-primary px-7 py-4 text-sm font-medium text-primary-foreground hover:bg-primary/90 transition-all hover:shadow-[0_14px_30px_-14px_oklch(0.34_0.055_142_/_0.55)]"
            >
              Conhecer produtos
            ...
            <a
              href="#unidades"
              className="inline-flex items-center justify-center gap-2 rounded-full border border-border bg-background px-7 py-4 text-sm font-medium text-foreground hover:bg-cream transition-colors"
            >
          ...
          <div className="mt-12 flex flex-wrap gap-x-6 md:gap-x-8 gap-y-3 text-[10px] md:text-[11px] uppercase tracking-[0.18em] text-muted-foreground">
            <span>Granel</span>
        ...
        >
          <div className="relative overflow-hidden rounded-[1.75rem] border border-border/70 shadow-[0_30px_80px_-30px_oklch(0.30_0.05_145_/_0.45)]">
            <img
              src={heroImg}
              alt="Fachada da Green Souk Mercado Natural em Campo Grande/MS"
              width={1280}
              height={1024}
              className="h-full w-full object-cover aspect-[4/5] transition-transform duration-[1200ms] hover:scale-[1.03]"
              fetchPriority="high"
            />
          </div>
